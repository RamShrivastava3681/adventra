...
function RunAllButton() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-[10px] bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-sm transition-all hover:-translate-y-px hover:shadow-md transition-all hover:bg-primary/90 disabled:opacity-50"
    >
      {runAll.isPending ? (
