...
function ProfilePage() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Account" title="Profile" description="Manage your personal information and photo." />
        ...
        <Card title="Personal information" className="md:col-span-2">
          <div className="space-y-4">
            <Field label="Full name">
              <input className="inp" value={form.contactName} onChange={(e) => setForm({ ...form, contactName: e.target.value })} placeholder="Your name" />
            </Field>
            <Field label="Company">
              <input className="inp" value={form.companyName} onChange={(e) => setForm({ ...form, companyName: e.target.value })} placeholder="Company name" />
            </Field>
            <Field label="Email">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field label="Phone">
                <input className="inp" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} placeholder="+1 555-0000" />
              </Field>
              <Field label="Address">
                <input className="inp" value={form.address} onChange={(e) => setForm({ ...form, address: e.target.value })} placeholder="123 Main St" />
              </Field>
            </div>
